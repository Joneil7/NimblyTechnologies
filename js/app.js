...
function select_item(select) {
	...
	if (select_type == 'input') {
		...
		select_type_content = '<div class="select__value icon-select-arrow _icon-arrow"><span>' + select_selected_text + '</span></div>';
	}
...
let slider_testimonials = new Swiper('.content-testimonials', {
	//autoplay: {
	//	delay: 3000,
	...
	spaceBetween: 100,
	navigation: {
		nextEl: '.content-testimonials__button-next',
		prevEl: '.content-testimonials__button-prev',
	},
	pagination: {
		el: '.content-testimonials__pagination',
		clickable: true,
	},
	speed: 800,
	//loop: true,
